       ...
       <div class="page-wrapper">
        ...
        <header class="main-header main-header--one sticky-header sticky-header--normal">
            <div class="main-header__logo main-header__logo--1 logo-retina">
                <a href="index.php">
                    <img src="assets/images/logo-light.png" alt="Transwide HTML" width="149">
                </a>
            ...
            <div class="container">
                ...
                <div class="main-header__inner">
                    <div class="main-header__logo main-header__logo--2 logo-retina">
                        <a href="index.php">
                            <img src="assets/images/logo-dark-2.png" alt="Transwide HTML" width="149">
                        </a>
                    </div><!-- /.main-header__logo -->
                    <div class="main-header__right">
                        <nav class="main-header__nav main-menu">
                            <?php require_once('parts/header/menu2.php'); ?>
