<?php $head_title = "Our Services 01 || Transwide || Professional Transportation & Logistics PHP Template" ?>
...
<?php require_once('parts/header/header.php'); ?>
        ...
        <section class="page-header">
            <div class="page-header__bg" style="background-image: url(assets/images/service-banner.png);"></div><!-- /.page-header__bg -->
            <div class="container">
